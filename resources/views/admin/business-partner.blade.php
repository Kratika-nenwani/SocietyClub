...
@section('content')
    <main class="main__content_wrapper">
        ...
        <div style="padding: 20px;">
            <div style="margin-bottom: 30px;">
                <h2 style="font-size: 24px; font-weight: bold; color: #333;">Business Partner</h2>
                ...
                <table style="width: 100%; border-collapse: collapse; background-color: white;">
                    <thead>
                        <tr>
                            ...
                            <th style="padding: 10px; background-color: #F5F7F8;">Business</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="viewFacilityPartnerModalLabel">Business Partner Details</h4>
    ...
    <div class="modal fade" id="addFacilityPartnerModal" tabindex="-1" aria-labelledby="addFacilityPartnerModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="addFacilityPartnerModalLabel">Add Business Partner</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="addFacilityPartnerForm" method="POST" action="{{ route('save-businessPartner') }}">
                        @csrf
                        <div class="mb-4">
    ...
    <div class="modal fade" id="editFacilityPartnerModal" tabindex="-1" aria-labelledby="editFacilityPartnerModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="editFacilityPartnerModalLabel">Edit Business Partner</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="editFacilityPartnerForm">
                        ...
                        <button type="submit" class="btn btn-primary">Update Business Partner</button>
                    </form>
...
@section('jscontent')
    ...
    $.ajax({
        url: '{{ route('save-businessPartner') }}', // Ensure this route points correctly to your controller
        method: 'POST',
        data: $(this).serialize(),
        success: function(response) {
            ...
            alert(response.success || 'Business partner added successfully!');
        ...
        error: function(xhr, status, error) {
            ...
            if (xhr.status === 422) { // Handle validation errors
                ...
                alert('An error occurred while adding the business partner.');
            }
        }
    });
});
            ...
            $('#editFacilityPartnerForm').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    data: formData,
                    success: function(response) {
                        alert(response.success || 'Business partner updated successfully!');
                        location.reload(); // Reload the page to reflect changes
                    },
                    error: function(xhr, status, error) {
                        console.error('Error:', error);
                        alert('An error occurred while updating the Business partner.');
                    }
                });
            });
